...
ROWS = [
    ...
    ("security", "Load the master key from the environment behind keys.py",
     ...
     "key.\n\n"
     "M1.1 reads FINHIVE_KEY_VERSION and FINHIVE_MASTER_KEY_V<n> from ops/.env.local. "
     "This is an INTERIM choice, "
    ...
    ("data", "Seed a development fixture into the encrypted database",
     ...
     "TRAP 2: the repository is public. data/loans.db was untracked on 2026-09-25, "
     "and .gitignore now ignores *.db and everything under src/Loan Manager/data/ "
     "except settings.json, so a demo database there cannot be committed by accident. "
     "Never force-add one (git add -f).\n\n"
