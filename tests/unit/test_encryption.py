...
@pytest.mark.parametrize("bad_key", [
    os.urandom(16), os.urandom(31), os.urandom(33),
])
def test_encrypt_rejects_non_32_byte_key(bad_key: bytes) -> None:
...
def test_decrypt_rejects_non_32_byte_key(bad_key: bytes) -> None:
    blob = encrypt_field("Sharma Traders", _KEY)
...
def test_encrypt_amount_canonicalizes(value: Decimal) -> None:
