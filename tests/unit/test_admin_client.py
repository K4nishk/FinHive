...
def test_create_or_get_user_returns_existing_id() -> None:
    opener = FakeOpener(
        [
...
def test_create_raises_when_dup_not_found() -> None:
...
def test_create_raises_on_unexpected_http_error() -> None:
