...
def test_exact_match_and_auto_fill_survive_encryption() -> None:
    async def _run() -> dict[str, object]:
        ...
        try:
            ...
            await _insert_loan(
                conn, org_id, "2026_01_001",
                "Sharma Traders", "Sharma Group",
                "Gupta Finance",
            )
            await _insert_loan(
                conn, org_id, "2026_01_002",
                "sharma traders", "Sharma Group",
                "Patel Finance",
            )
            await _insert_loan(
                conn, org_id, "2026_01_003",
                "Verma Traders", "Verma Group",
                "Gupta Finance",
            )
