...
would invalidate the isolation guarantees RLS adds
later (ARD v2.0.0 section 8).
...
sourced from `ops/.env.local` (gitignored, never committed):
    ...
    SUPABASE_URL           Base URL of the Supabase
                           project (default: local
                           supabase start gateway,
